...
const img2 = document.querySelector("#img-container-2");
...
btn.addEventListener("click", function () { 
  if(btn.value == "first"){
    ...
    document.getElementById("img-container").style.backgroundImage = "url('../media/images/man-at-arms-left.png')";
    document.getElementById("img-container-2").style.backgroundImage = "url('../media/images/man-at-arms-right.png')";
    ...
    document.getElementById("img-container").style.backgroundImage = "url('../media/images/crusader-left.png')";
    ...
    document.getElementById("img-container").style.backgroundImage = "url('../media/images/leper-left.png')";
    document.getElementById("img-container-2").style.backgroundImage = "url('../media/images/leper-right.png')";
